...
import type { UploadedFile as UploadedFileType } from "../../types/fileUploadWrapper.types";
import { VideoPlayer } from "../media-players/VideoPlayer";
import { ImagePlayer } from "../media-players/ImagePlayer";
import { DocumentPlayer } from "../media-players/DocumentPlayer";
  ...
  return (
    <>
      ...
      <Dialog open={showDeleteDialog} onClose={handleDeleteCancel}>
        <DialogTitle className="text-error-dark">
          Remove Uploaded File
        </DialogTitle>
        <DialogContent>
          <Typography className="text-primary-dark">
            Are you sure you want to remove "{uploadedFile.name}"? This action
            cannot be undone and you'll need to upload a new file.
          </Typography>
        </DialogContent>
        <DialogActions>
