...
import type { Option } from '@/types/roles.types';
...
export default function RequestForm() {
    ...
    useEffect(() => {
        ...
        const defaultOrg = organizationOptions.find(opt => opt.value === session.user.organization);
        const defaultRole = roleOptions.find(opt => opt.value === session.user.role);
