    ...
    <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <Button
          type="submit"
          disabled={loading}
          className={`w-full text-white font-medium py-2 rounded-full ${
            loading
      ...
      {/* Google Login */}
      <button
        className="w-full flex items-center justify-center gap-2 border border-gray-300 rounded-lg py-3 hover:bg-gray-50 transition"
