...
export const ServiceCard: React.FC<ServiceCardProps> = ({ title, image }) => {
  return (
    <div className="relative cursor-pointer bg-transparent transition-shadow duration-300 ease-in-out hover:shadow-[-8px_5px_76.1px_0px_#F04AF359] rounded-[40px] aspect-[16/10] bg-gradient-to-br from-blue-400 to-blue-800 overflow-hidden group translate-z-0">
